 ...
 * @returns {[state:{isError:string|null,isSuccess:string|null,isLoading:boolean},data:any,patch:function]}
 */
const usePatch = (endpoint, loadingMsg = "Loading", successMsg, errorMsg) => {
